static const xc_opcode_spec_t xc_opcode_spec[] = {
	...
	OPSPEC(    STMT",,        STD,        STD,        STD) /* 101 EXT_STMT */
	OPSPEC(FCALL_BEGIN",,        STD,        STD,        STD) /* 102 EXT_FCALL_BEGIN */
	OPSPEC(FCALL_END",,        STD,        STD,        STD) /* 103 EXT_FCALL_END */
	OPSPEC(     NOP",,     UNUSED,     UNUSED,     UNUSED) /* 104 EXT_NOP */
